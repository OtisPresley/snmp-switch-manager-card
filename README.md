...
[![HA installs](https://img.shields.io/badge/dynamic/json?url=https://analytics.home-assistant.io/custom_integrations.json&query=$.snmp_switch_manager_card.total&label=Installs&color=41BDF5)](https://analytics.home-assistant.io/custom_integrations.json)
...
1. Download the `snmp-switch-manager-card.js` and  `snmp-switch-manager-card-editor.js` files and place it in Home Assistant here:
