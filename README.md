...
[![hassfest](https://img.shields.io/github/actions/workflow/status/OtisPresley/snmp-switch-manager-card/hassfest.yaml?branch=main&label=hassfest)](https://github.com/OtisPresley/snmp-switch-manager-card/actions/workflows/hassfest.yaml)
...
[![CI](https://img.shields.io/github/actions/workflow/status/OtisPresley/snmp-switch-manager-card/ci.yaml?branch=main&event=push)](https://github.com/OtisPresley/snmp-switch-manager-card/actions/workflows/ci.yaml)

A lovelace card to be used with the SNMP Switch Manager integration for Home Assistant.
